...
public class UserInterface {
    ...
    private static final int PROCESS_PRODUCT_SHIPMENT = 5;
    private static final int SHOW_CLIENT = 6;
    private static final int SHOW_CLIENTS = 7;
    private static final int SHOW_PRODUCT = 8;
    private static final int SHOW_PRODUCTS = 9;
    private static final int SHOW_CLIENT_WISHLIST = 10;
    private static final int SHOW_CLIENT_TRANSACTIONS = 11;
    private static final int SHOW_PRODUCT_WAITLIST = 12;
    ...
    public void processClientOrder() {
        ...
        String productId = getToken("Enter product ID: ");
        int quantity = getNumber("Enter product quantity: ");
        String message = warehouse.processClientOrder(clientId, productId, quantity);
    ...
    public void processProductShipment() {
        ...
        warehouse.processProductShipment(productId, quantity);
    }
    ...
    public void showClientWishlist() {
        ...
        if (wishlist == null || !wishlist.hasNext()) {
            System.out.println("Client not found or no items in wishlist.");
            return;
        }
    ...
    public void showProductWaitlist() {
        ...
        if (waitlist == null || !waitlist.hasNext()) {
            System.out.println("Product not found or no clients on waitlist.");
            return;
        }
